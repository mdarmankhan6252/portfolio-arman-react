            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
                    <div className="bg-white space-y-4 px-4 py-8 shadow-blue-500 shadow-[0px_0px_5px_0Px] hover:shadow-none duration-500">
                        ...
                        <p>I will design eCommerce, Restaurant, School, Newspaper, Medical etc website for your online business.</p>
                    </div>
                    ...
                    <div className="bg-white space-y-4 px-4 py-8 shadow-blue-500 shadow-[0px_0px_5px_0Px] hover:shadow-none duration-500">
                        ...
                        <p>I will design eCommerce, Restaurant, School, Newspaper, Medical etc </p>
                    </div>
                </div>
                </div>
        </div>
